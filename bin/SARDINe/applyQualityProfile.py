...
if __name__ == "__main__":
	...
	parser.add_argument( '-q', '--qual-offset', default=33,  help="The position of the first quality encoding character in ASCII table (example: 33 for Illumina 1.8+). [Default: %(default)s]" )
