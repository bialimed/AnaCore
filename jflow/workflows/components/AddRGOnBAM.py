...
class AddRGOnBAM (Component):
    ...
    def define_parameters(self, in_aln, platforms, samples, libraries):
        # Parameters
        self.add_parameter_list( "libraries", "*****", default=libraries, required=True )
        self.add_parameter_list( "platforms", "*****", default=platforms, required=True )
        self.add_parameter_list( "samples", "*****", default=samples, required=True )
